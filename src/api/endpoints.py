...
async def run_pipeline(
    ...
    try:
        ...
        print(f"Error occurred in Pipeline: {str(e)}")

    # We allow competitor analysis to run as it does not rely on scraped/analyzed data.
    # ----------------------------Competitor Analysis-----------------------------
    if competitor_analysis:
        try:
            ...
            print(f"Error occurred in Competitor Analysis: {str(e)}")
