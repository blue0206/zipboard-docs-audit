...
async def run_competitor_analysis(articles: List[GapAnalysisInput]) -> CompetitorAnalysisOutput:
    """
...
async def refine_competitor_analysis_research(response_text: str) -> CompetitorAnalysisOutput:
    """
    ...
    response = await llm_service.get_llm_response(system_prompt=SYSTEM_PROMPT, input=input, mode="refine_competitor_analysis")
